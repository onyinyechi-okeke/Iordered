                        ...
                        <form>
                            ...
                            <div className='md:grid grid-cols-2 gap-6 justify-between mt-6 w-full'>
                                <div className='flex flex-col pb-4'>
                                    ...
                                    <input type='text' placeholder='John' id='firstname' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                                </div>
                                <div className='flex flex-col'>
                                    <label htmlFor="lastname" className='text-[14px]'>Last Name</label>
                                    <input type='text' placeholder='Doe' id='lastname' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                                </div>
                            </div>

                            <div className='flex flex-col mt-4'>
                                <label htmlFor="email" className='text-[14px]'>Email Address</label>
                                <input type='text' placeholder='johndoe@example.com' id='email' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                            </div>

                            <div className='flex flex-col mt-4'>
                                <label htmlFor="address" className='text-[14px]'>Address</label>
                                <input type='text' placeholder='eg.55 Abba str.' id='address' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                            </div>

                            <div className='md:grid grid-cols-2 gap-6 mt-4'>
                                <div className='flex flex-col pb-4'>
                                    <label htmlFor="city" className='text-[14px]'>City/Town</label>
                                    <input type='text' placeholder='eg.Lagos' id='city' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                                </div>
                                <div className='flex flex-col '>
                                    <label htmlFor="state" className='text-[14px]'>State</label>
                                    <input type='text' placeholder='eg.lagos' id='state' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                                </div>
                            </div>
                            ...
                            <div className='md:grid grid-cols-2 gap-6 mt-4'>
                                <div className='flex flex-col w-full pb-4'>
                                    ...
                                    <input type='text' placeholder='+23467890000' id='mobile' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                                </div>
                                <div className='flex flex-col w-full'>
                                    <label htmlFor="postal" className='text-[14px]'>Postal Code</label>
                                    <input type='text' placeholder='6578' id='postal' className='p-[14px] border-[0.92px] border-[#d0d5dd] rounded-[5.53px] outline-none placeholder:text-[14px]' />
                                </div>
                            </div>
                ...
                <section className='border-[0.92px] border-[#e4e7e6] rounded-[9.22px] xl:w-[40%] w-full mt-8 xl:mt-0 h-[80%] pt-[37.51px] xl:pb-12 pb-16 xs:px-[39.39px]'>
                    ...
                    <div className='border-b-[0.92px] border-[#d0d5dd]'>
                        ...
                        <div className='flex gap-3 cursor-pointer pb-5' onClick={handleDeliveryClick}>
                            ...
                            <p className='text-[18px] font-[500]'>Right Now</p>
                        </div>
                    </div>
                    ...
                    <button className='bg-[#e60023] p-[18px] text-white w-full rounded-[32.69px] delay-100 ease-in-out hover:bg-white hover:text-[#e60023] hover:border-[3px] border-[#e60023] hover:p-[14px] mt-2 mb-18 '>
                        Proceed to Pay
                    </button>
